...
public class MaximumCandiesYouCanGetFromBoxes_1298 {
    ...
    public static void main(String[] args) {
        MaximumCandiesYouCanGetFromBoxes_1298 solution = new MaximumCandiesYouCanGetFromBoxes_1298();
        solution.test01();
        solution.test02();
    }
    ...
    void test01() {
        ...
        int[] initialBoxes = {0};
        Assertions.assertEquals(16, maxCandies(status, candies, keys, containedBoxes, initialBoxes));
    }
    ...
    void test02() {
        ...
        int[] initialBoxes = {0};
        Assertions.assertEquals(6, maxCandies(status, candies, keys, containedBoxes, initialBoxes));
    }
